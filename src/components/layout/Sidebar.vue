        ...
        <div class="sidebar-inner">
            ...
            <div v-for="(index,navConfig) in navList" class="sidebar-nav" :class="{
                ...
                <div class="sidebar-title" v-if="navConfig.product">
                    <tooltip :content="navConfig.product.title" trigger="hover" class="admin-sidebar-tooltip" :disabled="type =='full'">
                        <div class="sidebar-title-inner"
                            ...
                            <span class="sidebar-manage">
                                <tooltip  :content="navConfig.product.title" trigger="hover"  class="admin-sidebar-tooltip">
                ...
                <ul class="sidebar-trans">
                    <li v-for="item in navConfig.serviceList" class="nav-item" :class="{'active' : item.active}">
                        <tooltip :content="item.title" trigger="hover" class="admin-sidebar-tooltip" :disabled="type =='full'">
                            <a :href="item.href">
                              <div class="nav-icon">
